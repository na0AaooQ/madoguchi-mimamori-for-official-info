...
| `E021` | 公開カードの公開言語に構造上公開可能な主案内先がない |
| `W001` | 確認中locale                                         |
| `I001` | 下書きlocale                                         |

Schema違反は`E002`、ファイル間の意味違反は主に`E003`から`E005`および`E010`から`E021`で分けて報告します。Schemaや検証基盤の実行異常は`RUN-E001`から`RUN-E005`、文書固有検証は`DOC-E`系を使用します。
