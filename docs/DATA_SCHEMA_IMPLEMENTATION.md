...
Schema検証後に意味検証、publication builder、公開成果物検証、site builder、HTML・URL・内部リンク・sitemap・hreflang検証を行います。previewとproductionは同じモデル・抽出・契約を利用し、BL-009工程Bで既存熊本productionを地域別URLへ接続しました。
