...
| リポジトリ内成果物 | BL-006-C第二公開単位まで反映したproduction静的サイト23ファイル。2026年8月9日に本番反映・公開後確認済み                     |
| ホスティング構成   | GitHub Pages、カスタムドメイン、HTTPS有効                                                                                  |
| デプロイ           | GitHub Pagesの手動workflowで公開。BL-006-C第一公開単位は2026年8月8日、第二公開単位は2026年8月9日に本番反映・公開後確認済み |

本リポジトリには、初期設計文書、ローカル品質管理基盤、架空preview Web画面MVP、TSV変換基盤、第一版の実在管理データを整備しています。管理JSONには、地域3件、団体4件、案内先20件、確認根拠33件、案内カード6件、カード案内先関連20件を登録しています。案内先と確認根拠は、人が確認した内容を管理JSONへ反映しています。

リポジトリ内では「公的機関・防災全般」「ライフライン」「道路・交通」「支援・復旧」の4セクションと対象データをpublishedとし、実在管理データから日英のproduction公開データと、正式サイトアイコン3点、production専用OGP画像1点を含む23ファイルの静的サイトを生成します。「命・安全・医療」はdraftです。BL-006-C「支援・復旧」は第一公開単位を2026年8月8日、第二公開単位を2026年8月9日にGitHub Pagesへ手動デプロイし、公開後の画面・リンク・一覧・404・sitemap等を確認済みです。現在のproductionでは4分野、6カード、20案内先を公開しています。既存の架空preview成果物は、画面と生成基盤の確認専用として分離しています。
...
将来は、約17のまとまりを次の5分野に整理する設計です。現在のproductionでは「公的機関・防災全般」「ライフライン」「道路・交通」「支援・復旧」の4分野を公開しています。未公開は「命・安全・医療」です。
...
「支援・復旧」は第一公開単位を2026年8月8日、第二公開単位「熊本県の義援金」を2026年8月9日に公開済みです。「命・安全・医療」は引き続きdraftです。第一版以降の掲載候補は[情報掲載方針](docs/INFORMATION_LISTING_POLICY.md)に記載しています。今後のカード数は固定しません。
...
分野ページはpublishedのセクションから動的に生成し、現在は「公的機関・防災全般」「ライフライン」「道路・交通」「支援・復旧」の4分野を公開対象としています。
...
`npm run check`でLint、書式、612件のテスト、fixture、文書、管理データ、公開データ、preview・productionサイト、再現性をまとめて確認できます。
2026年8月4日の第一版公開時、2026年8月7日のBL-006-B公開後、2026年8月8日のBL-006-C第一公開単位公開後、および2026年8月9日のBL-006-C第二公開単位公開後の確認でも`npm run check`は成功しています。
...
ローカルでは<http://127.0.0.1:4173/>を開きます。production成果物は`dist/site/production/`にあり、ルート言語選択、日英トップ、公開対象4分野、全団体・案内先一覧、プライバシーポリシー、`404.html`、`sitemap.xml`を含みます。GitHub Pagesへの反映はまだ行わず、正式base URL、手動workflow、公開後確認、再デプロイは[GitHub Pages手動デプロイ](docs/GITHUB_PAGES_DEPLOYMENT.md)を参照してください。
