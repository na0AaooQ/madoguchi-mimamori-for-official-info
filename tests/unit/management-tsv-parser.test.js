...
test('converts supported scalar and array types without normalizing strings', async (t) => {
  const valid = [
    ...
    ['Google Sheets boolean true', 'show_in_official_source_list', 'TRUE', true],
    ['Google Sheets boolean false', 'show_in_official_source_list', 'FALSE', false],
...
test('rejects invalid arrays, booleans, integers, and dates', async (t) => {
  const cases = [
    ...
    ['mixed-case boolean', 'show_in_official_source_list', 'True', 'TSV-E035'],
